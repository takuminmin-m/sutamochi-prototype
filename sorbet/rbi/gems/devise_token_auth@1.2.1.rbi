...
class ActionDispatch::Routing::Mapper
  ...
  #
  # source://devise_token_auth//lib/devise_token_auth/rails/routes.rb#117
  ...
  #
  # source://devise_token_auth//lib/devise_token_auth/rails/routes.rb#109
...
module DeviseTokenAuth::Concerns::User
  ...
  def build_auth_header(token, client = T.unsafe(nil)); end
  ...
  def update_auth_header(token, client = T.unsafe(nil)); end
